...
function EntityWalkState:init(entity, dungeon, room)
    self.entity = entity
...
function EntityWalkState:update(dt)
    ...
    local prevX, prevY = self.entity.x, self.entity.y
    ...
    if self.dungeon then 
        ...
        for k, object in pairs(objects) do 
            if object.solid and self.entity:collides(object) then 
                ...
                if object.type == 'pot' and love.keyboard.isDown('kp0') then 
    ...
    if self.bumped then 
        self.entity.x, self.entity.y = prevX, prevY
    end
end
