                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        function()
                            ...
                            --gStateStack:push(ExpMenuState(self))
                            gStateStack:push(ExpMenuState({statItems = statItemList, onClose = self.fadeOutWhite}))

                            --[[gStateStack:push(BattleMessageState('SUP', 
                            function()
