...
--[[
    This function is specifically made to piece out the key powerup from the
    sprite sheet. For this, we have to piece out the key powerup a little more
    manually, since they are in an awkward part of the sheet and small.
]]
function GenerateQuadsPowerUpKey(atlas)
    local x = 144
    local y = 192
...
--[[
    This function is specifically made to piece out the key block from the
    sprite sheet. For this, we have to piece out the key block a little more
    manually, since they are in an awkward part of the sheet and small.
]]
